<template>
  <li class="mb-7">
    <router-link
      :to="jobPageLink"
      class="hober:shadow-gray mx-auto block rounded border border-solid border-brand-gray-2 bg-white"
    >
      <div class="bottom-b border-slid mx-8 border-brand-gray-2 pb-2 pt-5">
